...
\begin{frame}{Benchmarker tout un marché digital}
  ...
  \begin{itemize}\footnotesize
    ...
    \item Domaine inconnu au départ : jargon maritime, spécificité et contraintes du secteur GNL
  \end{itemize}
  \vskip 6pt
...
\begin{frame}{Difficultés de cette approche}
  ...
  \begin{alertblock}{Informations rares liées au monde B2B GNL}
    Réponse : Deep Research combiné à des recherches personnelles (documentation technique, captures d'écran)
  \end{alertblock}
