  ...
  \begin{columns}[T]
    ...
    \begin{alertblock}{Ce qui complique la QA sur Polène}
      ...
      \begin{itemize}
        ...
        \item \textbf{Aucune spécification} fiable : compliqué d'avoir des points de repère pour les tests
...
\begin{frame}{L'obstacle du coût d'exécution}
  ...
  \begin{exampleblock}{La ré-architecture du prompt}
    ...
    \begin{itemize}
      ...
      \item Puis délègue les captures d'écran à Playwright avec les balises déjà identifiées \textbf{(Phase 2)} \\Résultat : $\sim$20 min par page
    \end{itemize}
  \end{exampleblock}
\end{frame}
